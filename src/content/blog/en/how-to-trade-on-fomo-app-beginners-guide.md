...
If you have a referral code, enter it during signup — not after. Codes typically apply at signup and give you 10% off your trading fees from that point forward. (We've got one on our [referral code page](/referral-code) if you don't already have one.)
...
Spot trades run roughly 0.5% per trade before any discount; a referral code brings that down by 10%. For the full breakdown, including perpetuals fees, see our [fees guide](/fees).
